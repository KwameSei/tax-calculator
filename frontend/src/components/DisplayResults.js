  ...
  return (
    <div className={classes.results_main}>
      <div className={classes.results_container}>
        <p className={classes.basic}>Net Salary: <span>GH₵ {results.basic_salary.toFixed(2)}</span></p>
        <p className={classes.gross}>Gross Salary: <span>GH₵ {results.gross_salary.toFixed(2)}</span></p>
        <p className={classes.gross}>Total PAYE Tax: <span>GH₵ {results.total_tax.toFixed(2)}</span></p>
